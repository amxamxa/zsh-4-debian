...
alias cat='batcat --paging=never -l log --force-colorization --terminal-width 80'
...
# alias ZRCg='gedit "$ZDOTDIR/.zshrc" & && source "$ZDOTDIR/.zshrc" && xcowsay "source $ZDOTDIR/.zshrc erfolgreich!${RESET}\n"'
# aliases.zsh
...
ls -dsAhp --group-directories-first --color=force * 
...
alias la='echo -e "\n\t${PINK}ls -plah: Zeigt alles, 											mit --group-directories-first${RESET}\n" && ls -plah --group-directories-first'
alias lt='
		echo -e "\n\t${PINK}ls -AsltpGH: Liste, sortiert nach Änderungsdatum (älteste zuerst)${RESET}\n" && ls -AsltpGH'alias lx='echo -e "\n\t${PINK}ls -AXlGh: Liste sortiert nach File-EextensionÄnderungsdatum${RESET}\n" && ls -AXlGhp' 

 ###### -------------------------------------------------------------------------

 alias e1='echo -e "\n\t${GELB} exa -A -l --tree -level 1${RESET}\n" && exa --tree --level 1 --all --long --color-scale --icons'
 alias e2='echo -e "\n\t${GELB} exa -A -l --tree -level 2${RESET}\n" && exa --tree --level 2 --all --long --color-scale --icons'
 alias e3='echo -e "\t${GELB} exa -A -l --tree -level 3${RESET}\n" && exa --tree --level 3 --all --long --color-scale --icons'
 alias e4='echo -e "\t${GELB} exa -A -l --tree -level 4${RESET}\n" && exa --tree --level 4 --all --long --color-scale --icons'
...
alias APTupdate='
	...
	alias APTsearch='echo -e "\t${PINK}Durchsuche Paketdatenbank${RESET}\n" && apt-cache search'  # apt search / Paketdatenbank
