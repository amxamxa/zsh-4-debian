...
## ------------------------------ ##
# [[ ... ]] ist eine erweiterte Syntax 
# für bedingte Anweisungen in der Zsh.
# == Vergleich der Strings
if [[ "$XDG_SESSION_TYPE" == "x11" ]]; then
 # X11 wird verwendet
 cowsay "X11 wird verwendet,\v xrandr für x11 sowie und 2 Bildschirme\v wurde erfolgreich ausgeführt"|lolcat           
 # echo -e "X11 wird verwendet,\v xrandr für x11 sowie und 2 Bildschirme\v wurde erfolgreich ausgeführt!"|lolcat 
