...
alias ll='echo -e "\t${PINK} LSD ${LILA} REVERSE ... mit  alles  ${GELB}in $(pwd)${PINK}(mit absoluter Zeit und Gruppenberechtigung): ${RESET}\n" &&	lsd --header --blocks 'permission' --blocks 'size'  --blocks 'links' --blocks 'name' --blocks 'user' --blocks 'group' --blocks 'date' \
	--total-size \
	--almost-all \
	--icon-theme 'fancy' \
	--human-readable \
...
alias lll='echo -e "\t${PINK} LSD ${LILA} REVERSE ... mit  alles  ${GELB}in $(pwd)${PINK} (mit absoluter Zeit und Gruppenberechtigung): ${RESET}\n" && lsd --date "+%d. %b %Y %H:%M Uhr" --long --header --blocks 'permission' --blocks 'size'  --blocks 'links' --blocks 'name' --blocks 'user' --blocks 'group' --blocks 'date' \
	--total-size \
	--almost-all \
	--icon-theme 'fancy' \
	--human-readable \
