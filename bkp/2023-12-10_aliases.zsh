...
alias ZSAVE='cp "$ZDOTDIR/.zshrc" "$ZDOTDIR/bkp/$( +'%F').zshrc.zsh" && cp "$HOME/.zshenv" "$ZDOTDIR/bkp/$(date +'%F').zshenv.zsh" && cp "$ZDOTDIR/aliases.zsh" "$ZDOTDIR/bkp/$(date +'%F')_aliases.zsh"'
