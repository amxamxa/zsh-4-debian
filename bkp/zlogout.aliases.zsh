...
D3() {
 echo -e "\n\t${inv2} du --max-depth=3 --separate-dirs --threshold=16K -BM -x $(pwd) 2> /dev/null | sort -hr | head -n 24${inv2} \t... wir reden über Pfad $(pwd)${res}}\n"
...
D1() {
 echo -e "\n\t${inv2} du --max-depth=1 --separate-dirs --threshold=16K -BM -x $(pwd) 2> /dev/null | sort -hr | head -n 24${inv2} \t... wir reden über Pfad $(pwd)${res}}\n"
