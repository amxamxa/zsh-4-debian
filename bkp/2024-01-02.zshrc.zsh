...
##     n a l a  s e a r c h 
### ------------------------------ ###
# the nala_search function will display the package information and prompt you to install the package using the standard input
SEArchNdestroy() 
{
...
#toilet -F gay -f pagga ".zshrc ..."|sed -e 's/^/\t\t\t/'|lolcat --seed=206
